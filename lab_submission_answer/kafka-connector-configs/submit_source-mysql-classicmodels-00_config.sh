...
curl -i -X PUT -H "Content-Type:application/json" \
  ...
  -d '{
            ...
            "table.whitelist": "classicmodels.payments, classicmodels.customers, classicmodels.products, classicmodels.orderdetails",
            ...
            "transforms.dropTopicPrefix.regex":"classicmodels.classicmodels.(.*)",
